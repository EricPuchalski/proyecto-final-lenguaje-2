    ...
    public void mostrarMenuPedido(){
        ...
        switch(opcion) {
            ...
            case 2:
                ...
                if (pedidoEncontrado!=null && empleadoController.findOne(cuitEmpleado)!=null){
            ...
            case 7:
                ...
                String cuitEmpleadoReceptor = scanner.nextLine();
                    ...
                    if (pedidoEnviarAEntrega != null && empleadoController.findOne(cuitEmpleadoReceptor)!=null) {
