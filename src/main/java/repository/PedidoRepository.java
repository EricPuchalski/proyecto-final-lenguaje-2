...
public class PedidoRepository {
    ...
    public void procesarPedido(String numero, String cuitEmpleado){
        ...
        if (pedidoEncontrado!=null){
            pedidoEncontrado.setEmpleado(empleadoRepository.buscarEmpleadoPorCuit(cuitEmpleado));
    ...
    public void enviarAEntrega(String numero, String cuitEmpleadoReceptor) {
        ...
        if (pedidoEncontrado != null) {
            ...
            if (remito != null) {
                ...
                Empleado empleadoReceptor = empleadoRepository.buscarEmpleadoPorCuit(cuitEmpleadoReceptor);
